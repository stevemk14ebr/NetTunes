 ...
 */
final public class StateMachineBuilder<State extends Enum<State>, EventType extends Enum<EventType>,T> {
   ...
   */
  public StateMachine<State, EventType,T> build() {
   ...
   */
  public StateMachineBuilder<State, EventType,T> addTransition(State startState, EventType eventType, State endState) {
   ...
   */
  public StateMachineBuilder<State, EventType,T> onEnter(State state, Runnable onEnter) {
   ...
   */
  public StateMachineBuilder<State, EventType,T> onExit(State state, Runnable onExit) {
    Node<State, EventType> node = nodes.get(state);
